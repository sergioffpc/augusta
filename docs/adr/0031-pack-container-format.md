...
3. **Index** — one entry per blob: type tag (Mesh/Texture/Audio/Collision/SpawnPoint/Hitbox/Scene/Script/Characters), path, offset, size. Written after the data section, since it needs the recorded offsets.
