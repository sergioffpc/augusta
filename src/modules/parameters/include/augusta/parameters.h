...
/// The most players a match holds: the highest Player count a scenario may set
/// (ADR-0043). protocol::kMaxPlayers is this, so the wire can carry any match.
inline constexpr std::size_t kMaxPlayerCount = 8;
...
/// player count 1 to kMaxPlayerCount, numbers finite, the stamina rates 0 or
