...
void RemoteInterpolator::Record(identity::SessionId session, float timestamp, const physics::BodyState& body) {
...
void RemoteInterpolator::Sync(std::span<const identity::SessionId> current) {
