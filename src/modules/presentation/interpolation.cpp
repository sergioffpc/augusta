...
void RemoteInterpolator::Record(protocol::SessionIdWire session, float timestamp, const physics::BodyState& body) {
...
void RemoteInterpolator::Sync(std::span<const protocol::SessionIdWire> current) {
