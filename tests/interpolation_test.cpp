...
constexpr auto kSessionA = static_cast<augusta::identity::SessionId>(1);
constexpr auto kSessionB = static_cast<augusta::identity::SessionId>(2);
...
TEST(RemoteInterpolatorTest, ASessionNoLongerInSyncsCurrentListIsNoLongerSampled) {
  ...
  const std::array<augusta::identity::SessionId, 1> still_here{kSessionA};
