...
constexpr auto kSessionA = static_cast<augusta::protocol::SessionIdWire>(1);
constexpr auto kSessionB = static_cast<augusta::protocol::SessionIdWire>(2);
...
TEST(RemoteInterpolatorTest, ASessionNoLongerInSyncsCurrentListIsNoLongerSampled) {
  ...
  const std::array<augusta::protocol::SessionIdWire, 1> still_here{kSessionA};
